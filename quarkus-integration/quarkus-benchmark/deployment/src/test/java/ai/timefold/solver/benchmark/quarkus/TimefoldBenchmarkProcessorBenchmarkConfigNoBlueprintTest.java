...
class TimefoldBenchmarkProcessorBenchmarkConfigNoBlueprintTest {

    @RegisterExtension
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            .overrideConfigKey("quarkus.timefold.benchmark.solver-benchmark-config-xml", "solverBenchmarkConfigNoBlueprint.xml")
            .overrideConfigKey("quarkus.timefold.benchmark.solver.termination.spent-limit", "1s")
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addAsResource("solverBenchmarkConfigNoBlueprint.xml")
