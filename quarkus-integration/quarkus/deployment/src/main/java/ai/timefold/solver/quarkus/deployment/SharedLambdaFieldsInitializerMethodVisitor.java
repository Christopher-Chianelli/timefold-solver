...
public class SharedLambdaFieldsInitializerMethodVisitor extends MethodVisitor {
    private final String internalClassName;
    private final Map<String, LambdaSharingMethodVisitor.InvokeDynamicArgs> generatedFieldNameToInvokeDynamicArgs;

    protected SharedLambdaFieldsInitializerMethodVisitor(int api, MethodVisitor methodVisitor,
